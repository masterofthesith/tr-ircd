...
char *lang_eng_funny[] = {
    ...
    /*
     * 001 RPL_WELCOME 
     */ ":%C 001 %s :Nice to meet you on %s IRC Network %s!%s@%s",
    /*
     * 002 RPL_YOURHOST 
     */ ":%C 002 %s :Your host is %s, running version %s",
    /*
     * 003 RPL_CREATED 
     */ ":%C 003 %s :This continent was created %s",
    /*
     * 004 RPL_MYINFO 
     */ NULL,
    /*
     * 005 RPL_ISUPPORT
     */ ":%C 005 %s %s :can be used on this continent",
    /*
     * 006 
     */ NULL,
    /*
    ...
    /*
     * 200 RPL_TRACELINK 
     */ ":%C 200 %s Connection %s%s %s %s",
    /*
     * 201 RPL_TRACECONNECTING 
     */ ":%C 201 %s Trial %d %s",
    /*
     * 202 RPL_TRACEHANDSHAKE 
     */ ":%C 202 %s Handshake %d %s",
    /*
     * 203 RPL_TRACEUNKNOWN 
     */ ":%C 203 %s whatever %d %s %d",
    /*
     * 204 RPL_TRACEOPERATOR 
     */ ":%C 204 %s Badguy %d %s %ld",
    /*
     * 205 RPL_TRACEUSER 
     */ ":%C 205 %s Person %d %s %ld",
    /*
     * 206 RPL_TRACESERVER 
     */ ":%C 206 %s Continent %d %dS %dC %s %s %ld",
    /*
     * 207 RPL_TRACESERVICE 
     */ ":%C 207 %s Mountain %d %s %d %ld :%s",
    /*
    ...
    /*
     * 231 RPL_SERVICEINFO 
     */ ":%C 231 %s :Mountain info...",
    /*
     * 232 RPL_ENDOFSERVICES 
     */ ":%C 232 %s :End of mountains",
    /*
     * 233 RPL_SERVICE 
     */ ":%C 233 %s :Service reply",
    /*
     * 234 RPL_SERVLIST 
     */ ":%C 234 %s Mountain %s (%s@%s) using %s %d :%s",
    /*
     * 235 RPL_SERVLISTEND 
     */ ":%C 235 %s :End of mountain listing",
    /*
     * 236 
     */ NULL,
    /*
    ...
    /*
     * 242 RPL_STATSUPTIME 
     */ ":%C 242 %s :Continent Exists %d days, %d:%02d:%02d",
    /*
     * 243 RPL_STATSOLINE 
     */ NULL,
    /*
    ...
    /*
     * 251 RPL_LUSERCLIENT 
     */ ":%C 251 %s :There are %d persons and %d phantoms on %d continents",
    /*
     * 252 RPL_LUSEROP 
     */ ":%C 252 %s %d :Chat addicted here",
    /*
     * 253 RPL_LUSERUNKNOWN 
     */ ":%C 253 %s %d :unknown waterfalls(s)",
    /*
     * 254 RPL_LUSERCHANNELS 
     */ ":%C 254 %s %d :countries formed",
    /*
     * 255 RPL_LUSERME 
     */ ":%C 255 %s :I have %d lifeforms and %d continents",
    /*
     * 256 RPL_ADMINME 
     */ ":%C 256 %s :Foundation info about %s",
    /*
     * 257 RPL_ADMINLOC1 
     */ NULL,
    /*
    ...
    /*
     * 261 RPL_TRACELOG 
     */ ":%C 261 %s Description %s %d",
    /*
     * 262 
     */ ":%C 262 %s %s :End of TRACE",
    /*
     * 263 
     */ ":%C 263 %s :Continent too small!",
    /*
     * 264 
     */ NULL,
    /*
     * 265 RPL_LOCALUSERS 
     */ ":%C 265 %s :Current local persons: %d, max %d",
    /*
     * 266 RPL_GLOBALUSERS  
     */ ":%C 266 %s :Current global persons: %d, max %d",
    /*
     * 267 
     */ NULL,
    /*
    ...
    /*
     * 305 RPL_UNAWAY 
     */ ":%C 305 %s :Nice to see you return",
    /*
     * 306 RPL_NOWAWAY 
     */ ":%C 306 %s :Sad that you have left us alone",
    /*
     * 307 RPL_WHOISREGNICK 
     */ ":%C 307 %s %s :has identified for this building",
    /*
     * 308 RPL_WHOISADMIN 
     */ NULL,
    /*
    ...
    /*
     * 331 RPL_NOTOPIC 
     */ ":%C 331 %s %s :Nothing to talk about",
    /*
     * 332 RPL_TOPIC 
     */ NULL,
    /*
     ...
     */ ":%C 350 %s %H :End of Channel Banned Channels List",
    /*
     * 351 RPL_VERSION 
     */ NULL,
    /*
    ...
    /*
     * 381 RPL_YOUREOPER 
     */ ":%C 381 %s :You have now entered the stargate",
    /*
     * 382 RPL_REHASHING 
     */ ":%C 382 %s %s :Rehashing",
    /*
     ...
     */ ":%C 477 %s %s :You need a registered nick to join that channel.",
    /*
     * 478 ERR_BANLISTFULL 
...
void _modinit(void)
{
    lang_add_table(_langname, _helpdir, lang_eng_funny);
}
