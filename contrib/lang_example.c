...
char *lang_example[] = {
    ...
    /*
     * 004 RPL_MYINFO 
     */ ":%C 004 %s %s %s aAinorRtwx abcefhiIklmMnoOpqrRstTuvxz "
	"abefhIklMouvz",
    /*
     * 005 RPL_ISUPPORT
    ...
    /*
     * 386 RPL_IRCOPSSTART 
     */ ":%C 386 :Online IRC-Operators",
    /*
     * 387 RPL_IRCOPS 
     */ ":%C 387 :%s",
    /*
     * 388 RPL_ENDOFIRCOPS 
     */ ":%C 388 :End of /IRCOPS list.",
    /*
     * 389 RPL_HASH
     */ ":%C 389 %s :%s",
    /*
     ...
     */ ":%C 408 %s %s :You cannot use colors on this channel. Not sent: %s",
    /*
     * 409 ERR_NOORIGIN 
...
void _modinit(void)
{
    lang_add_table(_langname, _helpdir, lang_example);
}
